...
// ====================================================================
// Global settings for menu
// ====================================================================
#macro MENU_MARGIN    32
#macro MENU_MAX       160
// ====================================================================
// Enums for screens and widget types
// ====================================================================
enum MenuScreen {
    Main             = 0,
    Settings         = 1,
...
// ====================================================================
// Name: menuIsSettingsPanel
// Description: Checks if the menu is currently in a settings screen
// NB: Possibly don't need, but will need restructure
// ====================================================================
function menuIsSettingsPanel() {
    return (menu_screen == MenuScreen.Settings) || (menu_screen == MenuScreen.SettingsControls);
}
// ====================================================================
// Name: menuSettingsGetScroll
// Description: Gets current mouse scroll for extended menu screens
// ====================================================================
function menuSettingsGetScroll() {
    if (!is_real(menu_settings_scroll)) return 0; 
        
    return clamp(menu_settings_scroll, 0, menu_settings_scroll_max);
}
// ====================================================================
// Name: menuSettingsGetScroll
// Description: Sets current mouse scroll for extended menu screens
// ====================================================================
function menuSettingsSetScroll(_value) {
    if (!is_real(_value)) _value = 0;
    menu_settings_scroll = clamp(_value, 0, menu_settings_scroll_max);
}
// ====================================================================
// Name: menuSettingsScrollTo
// Description: ?? Genuinely not sure, need to revisit
// ====================================================================
function menuSettingsScrollTo(_value) {
    menuSettingsSetScroll(_value);
}
// ====================================================================
// Name: menuSettingsScrollBy
// Description: ?? Genuinely not sure, need to revisit
// ====================================================================
...
// ====================================================================
// Name: menuSettingsGetPanelRect
// Description: Defines the panel boundaries for the menu screens
// ====================================================================
function menuSettingsGetPanelRect() {
    var _gui_w = display_get_gui_width();
    var _gui_h = display_get_gui_height();

    var _margin = MENU_MARGIN;
    var _available_w = max(MENU_MAX, _gui_w - _margin * 2);
    var _available_h = max(MENU_MAX, _gui_h - _margin * 2);
...
// ====================================================================
// Name: menuSettingsGetContentRect
// Description: Defines the content panel boundaries for the menu screens
// ====================================================================
...
// ====================================================================
// Name: menuSettingsGetPageScrollAmount
// Description: Gets the current ammount of scroll on a screen
// ====================================================================
...
function menuGetLayout() {
    var _gui_w = display_get_gui_width();
    var _gui_h = display_get_gui_height();
    var _mode  = menu_screen;
    // Set layout of settings screens
    ...
    // Set layout of main menu screen
    else {
        return {
            // NEED TO TEST THESE VALUES
            cx:       _gui_w * 0.5,
...
// NEED to discern why so many different boundary getters
// ====================================================================
...
function menuSettingsCloneStruct(_source)
{
    ...
    _clone.control_scheme = _source.control_scheme;
...
function menuSettingsComputeDirty()
{
    ...
    var _vol_pending  = settings_pending.volume;
    var _vol_applied  = settings_applied.volume;
    if (abs(_vol_pending - _vol_applied) > 0.0001) return true;

    var _screen_pending = settings_pending.screen_size_index;
    var _screen_applied = settings_applied.screen_size_index;
    if (_screen_pending != _screen_applied) return true;

    var _scheme_pending = menuSettingsGetControlScheme();
    var _scheme_applied = ControlScheme.KeyboardMouse;
    if (_scheme_pending != _scheme_applied) return true;

    var _bindings_pending = settings_pending.key_bindings;
    var _bindings_applied = settings_applied.key_bindings;
...
function menuSettingsGetVolume()
{
    ...
    var _value = settings_pending.volume;
...
function menuSettingsGetScreenIndex()
{
    ...
    var _index = settings_pending.screen_size_index;
...
function menuKeybindingIsCapturingEntry(_entry)
{
    ...
    var _capture = menu_keybinding_capture;
    var _scheme_entry = menuSettingsGetControlScheme();
    var _scheme_capture = menuSettingsGetControlScheme();
