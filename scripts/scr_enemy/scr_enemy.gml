...
{
    if (!variable_instance_exists(id, "enemy_type")) enemy_type = EnemyType.Melee;
    if (!variable_instance_exists(id, "enemy_toughness")) enemy_toughness = EnemyToughness.Normal;

    // Apply configurable stats for type & toughness
    enemyConfigAssign(id, enemy_type, enemy_toughness);
    ...
    if (!variable_instance_exists(id, "enemy_idle_speed")) enemy_idle_speed = max(0.1, enemy_speed * 0.6);
    if (!variable_instance_exists(id, "enemy_wander_radius")) enemy_wander_radius = 96;
    if (!variable_instance_exists(id, "enemy_idle_pause_min")) enemy_idle_pause_min = 18;
    if (!variable_instance_exists(id, "enemy_idle_pause_max")) enemy_idle_pause_max = 54;
    if (!variable_instance_exists(id, "enemy_idle_tolerance")) enemy_idle_tolerance = 4;
    if (!variable_instance_exists(id, "enemy_melee_cooldown_max")) enemy_melee_cooldown_max = 42;
    if (!variable_instance_exists(id, "enemy_melee_attack_duration")) enemy_melee_attack_duration = 12;
    if (!variable_instance_exists(id, "enemy_melee_attack_distance")) enemy_melee_attack_distance = 20;
    if (!variable_instance_exists(id, "enemy_melee_damage")) enemy_melee_damage = 8;
    if (!variable_instance_exists(id, "enemy_projectile_cooldown_max")) enemy_projectile_cooldown_max = 0;
    if (!variable_instance_exists(id, "enemy_projectile_life")) enemy_projectile_life = 120;
    if (!variable_instance_exists(id, "enemy_projectile_damage")) enemy_projectile_damage = 6;
    if (!variable_instance_exists(id, "enemy_projectile_speed")) enemy_projectile_speed = 4.5;
    if (!variable_instance_exists(id, "enemy_projectile_range")) enemy_projectile_range = 320;
    if (!variable_instance_exists(id, "enemy_projectile_boss_extra")) enemy_projectile_boss_extra = 0;
    if (!variable_instance_exists(id, "enemy_projectile_boss_spread")) enemy_projectile_boss_spread = 12;
    if (!variable_instance_exists(id, "enemy_retreat_radius")) enemy_retreat_radius = 0;
    if (!variable_instance_exists(id, "enemy_retreat_speed")) enemy_retreat_speed = enemy_speed;
    if (!variable_instance_exists(id, "enemy_active_delay_max")) enemy_active_delay_max = 0;
    if (!variable_instance_exists(id, "enemy_melee_extra_attacks")) enemy_melee_extra_attacks = 0;
    if (!variable_instance_exists(id, "enemy_melee_extra_spread")) enemy_melee_extra_spread = 20;
    if (!variable_instance_exists(id, "enemy_melee_attack_sprite"))
    {
    ...
    enemy_melee_cooldown_timer   = 0;
    enemy_projectile_cooldown    = (enemy_projectile_cooldown_max > 0) ? irandom_range(0, enemy_projectile_cooldown_max) : 0;
}
...
function enemyPerformMeleeAttack(_target)
{
    ...
    if (enemy_toughness == EnemyToughness.Boss && enemy_melee_extra_attacks > 0)
    {
